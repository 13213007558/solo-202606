...
const users: User[] = [
  {
    ...
    joinedEvents: [
      { eventId: 'event-3', eventName: '海滩清洁行动', hours: 8, joinedAt: '2026-06-01', eventDate: '2026-06-15T08:00:00' },
      { eventId: 'event-6', eventName: '环保知识进校园', hours: 6, joinedAt: '2026-05-10', eventDate: '2026-05-20T14:00:00' },
      { eventId: 'event-5', eventName: '旧物交换市集', hours: 4, joinedAt: '2026-04-05', eventDate: '2026-04-22T10:00:00' },
      { eventId: 'event-1', eventName: '春季植树活动', hours: 0, joinedAt: '2026-06-15', eventDate: '2026-07-20T09:00:00' },
      { eventId: 'event-2', eventName: '社区垃圾分类宣传', hours: 0, joinedAt: '2026-06-20', eventDate: '2026-07-25T14:00:00' },
      { eventId: 'event-4', eventName: '城市公园环保徒步', hours: 0, joinedAt: '2026-06-25', eventDate: '2026-08-05T07:30:00' },
    ],
    notifications: [],
  },
  {
