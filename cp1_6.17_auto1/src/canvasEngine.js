...
export class CanvasEngine {
    ...
    noiseCanvas = null;
    gridVisible = true;
    constructor(canvas, container, userId, callbacks) {
        this.canvas = canvas;
    ...
    renderPath(ctx, points, color, width) {
        if (points.length < 2)
            return;
