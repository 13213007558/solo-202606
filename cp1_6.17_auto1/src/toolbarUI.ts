import { ToolType } from './canvasEngine';
...
export class ToolbarUI {
  ...
  constructor(callbacks: ToolbarCallbacks) {
    ...
    this.brushSize = document.getElementById('brush-size') as HTMLInputElement;
    this.brushPreviewDot = document.getElementById('brush-preview-dot')!;
    this.penBtn = document.getElementById('pen-btn') as HTMLButtonElement;
    ...
    this.stickyBtn = document.getElementById('sticky-btn') as HTMLButtonElement;
    this.clearBtn = document.getElementById('clear-btn') as HTMLButtonElement;
    this.gridBtn = document.getElementById('grid-btn') as HTMLButtonElement;
  ...
  setColor(color: string, emit = false): void {
  ...
  setBrushSize(size: number, emit = false): void {
  ...
  static showNotification(message: string, type: 'join' | 'leave' = 'join'): void {
